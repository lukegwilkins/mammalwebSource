...
<?php
	...
	try{
		...
		//remove the file location of querycarousel.php from the url

		$url = str_replace("/mammalwebDemo", "", $url);
		$url = str_replace("/querycarousel.php?", "", $url);
...
?>
    ...
    <div class="container">
        ...
        <div class="col-md-12" align="center">
			<button type="button" class="btn btn-success btn-md" onclick="window.location.href='carouselfilter.html'">Click to return to Carousel Filter</button>
		</div>
		</div>
		</div>
</body>
